// Tarifas y distancias — PLACEHOLDER de presentacion.
// Los importes son orientativos y los pone el transportista antes de publicar.
// Las distancias si son reales (km por autovia desde Madrid).
...
export const DESTINOS = [
  ...
  { id: 'malaga',       nombre: 'Malaga',               km: 530 },
  ...
  { id: 'coruna',       nombre: 'A Coruna',             km: 595 },
  { id: 'santander',    nombre: 'Santander',            km: 435 },
  { id: 'oviedo',       nombre: 'Oviedo',               km: 450 },
  { id: 'granada',      nombre: 'Granada',              km: 420 },
  { id: 'cordoba',      nombre: 'Cordoba',              km: 400 },
  { id: 'almeria',      nombre: 'Almeria',              km: 550 },
  { id: 'cadiz',        nombre: 'Cadiz',                km: 655 },
  { id: 'valladolid',   nombre: 'Valladolid',           km: 195 },
  { id: 'pamplona',     nombre: 'Pamplona',             km: 405 },
  { id: 'sansebastian', nombre: 'San Sebastian',        km: 455 },
  { id: 'denia',        nombre: 'Denia',                km: 460, nautico: true },
  { id: 'javea',        nombre: 'Javea',                km: 470, nautico: true },
...
export const CARGAS = [
  ...
  { id: 'barco', nombre: 'Embarcacion', base: 140, km: 0.85, min: 290 },
  { id: 'coche', nombre: 'Coche',       base: 85,  km: 0.55, min: 190 },
];

// Por encima de 2,55 m de ancho hace falta autorizacion complementaria de
// circulacion. Eso cuesta dinero y tiempo, y el precio lo tiene que reflejar.
